...
def _get_fd_solver_module():
    ...
    if _FD_SOLVER_MODULE is None:
        _FD_SOLVER_MODULE = import_module("pepsy.solvers.finite_difference")
...
def _run_fd_adam(
    ...
    *,
    ...
    """Delegate finite-difference Adam backend to :mod:`pepsy.solvers.finite_difference`."""
...
def _run_fd_scipy(
    ...
    *,
    ...
    """Delegate finite-difference SciPy backend to :mod:`pepsy.solvers.finite_difference`."""
    fd_solver_module = _get_fd_solver_module()
...
def _run_fd_nlopt(
    ...
    *,
    ...
    """Delegate finite-difference NLopt backend to :mod:`pepsy.solvers.finite_difference`."""
    fd_solver_module = _get_fd_solver_module()
