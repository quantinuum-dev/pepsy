"""Shared symmetry, Hamiltonians, and compatible imports."""
...
for _name in (
    '_term_dense_and_phys_maps',
    '_term_dense_and_phys_map',
    '_svd_rank_cutoff',
    '_decompose_neutral_two_site_term',
    '_fermion_parity_operator',
    '_charged_op_needs_fermion_string',
    '_add_local_transition',
    '_assemble_symmray_mpo',
    '_build_factorized_pair_mpo',
    '_build_fermionic_model_mpo',
    '_add_native_term_to_mpo',
    '_native_local_term_mpo',
    '_generic_symhamiltonian_to_mpo',
    '_group_symhamiltonian_terms_by_charge',
):
    _LEGACY_MODULES[_name] = "..operators._symmetric_mpo"
...
class SymHamiltonian:
    ...
    def to_mpo(
        ...
        *,
        ...
        """
        from ..operators._symmetric_mpo import (
            _assemble_symmray_mpo,
            _build_fermionic_model_mpo,
            _generic_symhamiltonian_to_mpo,
            _group_symhamiltonian_terms_by_charge,
