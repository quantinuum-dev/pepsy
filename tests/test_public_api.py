...
_EXPECTED_IN_ALL = [
    ...
    "compile_stim_circuit", "run_noisy_shots", "run_stim_shots",
    "sample_noisy_gate_stream", "sample_noisy_gate_streams", "sample_stim_circuit", "sample_stim_circuits",
...
_CALLABLE_EXPORTS = [
    ...
    "FDSolver", "MpsEnergyOptimizer", "MpsOptimizer", "MpoOptimizer", "PepsEnergyOptimizer", "PepsOptimizer", "SimpleUpdateGen", "SymDMRG2", "PEPSSampleResult", "PepsBpSampler", "compile_stim_circuit", "run_noisy_shots", "run_stim_shots", "sample_noisy_gate_stream", "sample_noisy_gate_streams", "sample_stim_circuit", "sample_stim_circuits",
