...
_EXPECTED_IN_ALL = [
    ...
    "FDSolver", "MpsOptimizer", "MpoOptimizer", "PepsEnergyOptimizer", "PepsOptimizer", "SimpleUpdateGen", "PEPSSampleResult",
...
_CALLABLE_EXPORTS = [
    ...
    "FDSolver", "MpsOptimizer", "MpoOptimizer", "PepsEnergyOptimizer", "PepsOptimizer", "SimpleUpdateGen", "PEPSSampleResult", "PepsBpSampler",
